...
class _StandardButtonStyle extends JourneyButtonStyle {
  ...
  const _StandardButtonStyle({
    ...
    this.completeIcon,
    this.backText = 'nylo.journey.back',
    this.nextText = 'nylo.journey.next',
    this.completeText = 'nylo.journey.finish',
    this.backTextStyle,
    this.nextTextStyle,
  ...
  Widget buildNextButton(
    ...
    final IconData buttonIcon = isLastStep && completeIcon != null
        ? completeIcon!
        : nextIcon;
    final String buttonText = isLastStep ? completeText : nextText;
    final TextStyle? buttonTextStyle = isLastStep
        ? completeTextStyle
        : nextTextStyle;
